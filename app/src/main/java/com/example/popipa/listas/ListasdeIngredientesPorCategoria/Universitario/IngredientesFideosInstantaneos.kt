...
class IngredientesFideosInstantaneos {
    companion object {
        val listaFideosInstantaneos = listOf<Ingrediente>(
            Ingrediente(
                "Fideos Instantáneos",
                "1 paquete"
            ),
            ...
            Ingrediente(
                "Saborizante de Fideos Instantáneos",
            ...
            Ingrediente(
                "Tofu o Pollo a la Parrilla (opcional)",
                "Al gusto"
            ),
            Ingrediente(
